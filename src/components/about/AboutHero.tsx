    ...
    <section className="pt-40 pb-28 bg-gradient-to-b from-white to-slate-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-8 text-lg text-slate-600 leading-8 max-w-2xl mx-auto">
            We help businesses, startups and institutions embrace digital transformation
            through software development, AI solutions, training programs and technology consulting.
          </p>
